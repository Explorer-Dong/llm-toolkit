...
class AppData:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"CustomClass(module_name={self.module_name!r}, base_url={self.base_url!r}, "
...
def create_openhands_container(auto_entry: AppData) -> str:
    ...
    env_vars = {"SANDBOX_RUNTIME_CONTAINER_IMAGE": "docker.all-hands.dev/all-hands-ai/runtime:0.49-nikolaik", "LOG_ALL_EVENTS": "true"}
...
def start_app(app_data: AppData):
    ...
    llm_config_name = "benchmark_model"
...
api_key = "{app_data.sk}"
        ...
        updated_content = updated_content.replace("{{LLM_CONFIG_NAME}}", llm_config_name)
    ...
    env_vars = {
        ...
        "AGENT_LLM_CONFIG": llm_config_name,
    }
    ...
    try:
        ...
        container = create_advanced_container(
            ...
            image_name="ghcr.io/all-hands-ai/openhands:0.56",  # Image name
            container_name=container_name,  # Container name
            env_vars=env_vars,  # Environment variables
            ports=ports,  # Port mappings
            volumes=volumes,  # Volume mounts
        ...
        return {"task_uuid": task_uuid, "module_name": app_data.module_name, "pro_name": pro_name, "status": "error", "error": str(e)}
                ...
                try:
                    ...
                    if "test_data" in save_data:
                        ...
                        save_data["test_data_info"] = {
                            ...
                            "py_test_file_count": len(test_data.pyTestFileList)
                            if hasattr(test_data, "pyTestFileList") and test_data.pyTestFileList
                            else 0,
                        }
